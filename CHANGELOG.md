...
- AI-estimated effort levels in ideas skill — the skill evaluates effort itself based on project context rather than asking the user, with one-sentence rationale and user override

## [0.18.1] - 2026-03-16

### Changed

- `iconik-sow-generator` now prompts for a Google Drive folder link during the interview instead of silently using a hardcoded default folder
...
- Enhanced `/trellis:meeting-summary` skill with audience calibration and visual capture support
...
- `/trellis:context-handoff` skill — generates a structured handoff document (`handoff.md`) for seamless session continuity
  - Captures git state, completed/in-progress/remaining work, decisions with rationale, dead ends, and concrete resume instructions
  - Designed for AI-to-AI context transfer when sessions approach context limits or work is paused
  - Triggers on "handoff", "context handoff", "save context", or manual invocation
...
- `marketplace.json` for plugin marketplace installation from private GitHub repositories
- Comprehensive GITHUB_TOKEN setup instructions in README for private repo access
  - Step-by-step Personal Access Token creation guide
  - Shell profile configuration examples
  - Alternative settings.json configuration method

### Changed

- Updated installation instructions to use marketplace-based plugin installation
- Replaced simple `claude plugin install` command with full authentication workflow
...
[Unreleased]: https://github.com/NorthShoreAutomation/trellis/compare/v0.19.0...HEAD
[0.19.0]: https://github.com/NorthShoreAutomation/trellis/compare/v0.18.1...v0.19.0
[0.18.1]: https://github.com/NorthShoreAutomation/trellis/compare/v0.18.0...v0.18.1
